...
def download_board(board_url: str, download_folder: str, logger=None, log_level=logging.INFO) -> None:
    ...
    with PinterestDownloader(page_timeout=10, num_threads=5, min_resolution='0x0', size_compare_mode=None, logger=logger) as dl:
        dl.download_board_v2(board_url=board_url, download_folder=download_folder)
